...
class PSOApproach(Approach):
    ...
    def run(self):
        ...
        for t in range(1,T):
            ...
            swarm.evaluateRoute()
            #4. Update pbest
            swarm.evaluatePbest(self.world,self.useLocalImprovement)
            #5. Update gbest
            swarm.evaluateGbest()
            #6. Update lbest
        ...
        final_routes = p.decode(p.dimensions,vehicles,self.world,self.useLocalImprovement) 
...
from genericFunctions import calcDistance,CalcDistance2,CalcDistance3,CalcDistance4,\
CalcDimensionalDistance
...
class Particle():
    ...
    def decode(self,dimensions,vehicle,world,useLocalImprovement):
